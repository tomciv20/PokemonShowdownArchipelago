...
ACHIEVEMENTS = [
    ...
    "Win a battle using Skill Swap",
    "Win a battle using Entrainment",
    "Win a battle using Role Play",
    "Win a battle using Toxic",
    "Win a battle using Last Resort",
    "Win a battle using Stealth Rock",
    "Win a battle using Explosion",
    "Win a battle using Bulldoze",
    "Win a battle using Reversal",
    "Win a battle using Counter",
    "Win a battle using Echoed Voice",
    "Win a battle using Round",
    "Win a battle using Growl",
    "Win a battle using Light Screen",
    "Win a battle using Reflect",
    "Win a battle using Quick Attack",
]
...
POPULAR_ITEMS = [
    "air-balloon", "assault-vest", "choice-band", "choice-scarf", "choice-specs",
    "expert-belt", "focus-sash", "heavy-duty-boots", "leftovers", "life-orb",
    "loaded-dice", "mental-herb", "power-herb", "rocky-helmet", "salac-berry",
]
